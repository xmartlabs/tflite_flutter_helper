...
Pointer<TfLiteBertNLClassifier> Function(
        Pointer<Utf8> modelPath, Pointer<TfLiteBertNLClassifierOptions> options)
...
typedef _BertNLClassifierFromFileAndOptions_native_t
...
typedef _BertNLClassifierFromFile_native_t = Pointer<TfLiteBertNLClassifier>
    Function(Pointer<Utf8> modelPath);

// Invokes the encapsulated TFLite model and classifies the input text.
Pointer<TfLiteCategories> Function(
        Pointer<TfLiteBertNLClassifier> classifier, Pointer<Utf8> text)
    BertNLClassifierClassify = tflitelib
        .lookup<NativeFunction<_BertNLClassifierClassify_native_t>>(
            'BertNLClassifierClassify')
        .asFunction();

typedef _BertNLClassifierClassify_native_t = Pointer<TfLiteCategories> Function(
    Pointer<TfLiteBertNLClassifier> classifier, Pointer<Utf8> text);

// Deletes BertNLClassifer instance
void Function(Pointer<TfLiteBertNLClassifier>) BertNLClassifierDelete =
    tflitelib
        .lookup<NativeFunction<_BertNLClassifierDelete_native_t>>(
            'BertNLClassifierDelete')
        .asFunction();

typedef _BertNLClassifierDelete_native_t = Void Function(
    Pointer<TfLiteBertNLClassifier>);
